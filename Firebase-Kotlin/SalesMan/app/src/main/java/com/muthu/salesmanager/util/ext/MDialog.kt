 ...
 * Ref : https://github.com/pawegio/KAndroid/blob/master/kandroid/src/main/kotlin/com/pawegio/kandroid/KDialog.kt
 */
...
fun Fragment.alert(
        message: String,
        title: String? = null,
        init: (MAlertDialogBuilder.() -> Unit)? = null
...
fun Context.alert(
        ...
        title: String? = null,
        init: (MAlertDialogBuilder.() -> Unit)? = null
) = MAlertDialogBuilder(this).apply {
...
fun Fragment.alert(init: MAlertDialogBuilder.() -> Unit): MAlertDialogBuilder = activity.alert(init)

fun Context.alert(init: MAlertDialogBuilder.() -> Unit) = MAlertDialogBuilder(this).apply { init() }
...
class MAlertDialogBuilder(val ctx: Context) {
    ...
    fun customView(layoutId: Int): View {
        var view: View = LayoutInflater.from(ctx).inflate(layoutId, null)
        builder.setView(view)
        return view
    }
